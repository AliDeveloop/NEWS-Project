    ...
    <div class="all-web">
        ...
        <div class="panel-welocome">
            <div class="panel-box post-box">
                <h2 class="titr panel-titr">ویرایش خبر فوری</h2>

                <div class="form-panel">
                    <?php
                    $postid = $_GET['postid'];
                    $query = "SELECT * FROM `breakingnews` where `id` =$postid;";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        <form action="../code.php" method="Post" enctype="multipart/form-data">
                            ...
                            <input class="input-form submit-form" type="submit" name="btnbreakingnewsupdate"
                                value="بروزرسانی پست" />
                            <br />
                        </form>
                    <?php } ?>
