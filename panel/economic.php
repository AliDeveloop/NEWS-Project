    ...
    <div class="all-web">
        ...
        <div class="panel-welocome">
            <div class="panel-box post-box">
                <h2 class="titr panel-titr">خبر جدید اقتصادی</h2>
                <p>
                    <?php
                    if (isset($_GET["empty"])) {
                ...
                <div class="form-panel">
                    <form action="../code.php" method="Post" enctype="multipart/form-data">
                        ...
                        <textarea class="input-form textarea-form" placeholder="متن خبر " name="content"
                            required></textarea>
                        <input class="input-form submit-form" type="submit" name="btneconomicsend" value="انتشار پست" />
                        <br />
                    </form>
                </div>
            </div>
        ...
        <div class=" panel-manage">
            <div class="panel-box post-box">
                <h2 class="titr panel-titr">مشاهده اخبار اقتصادی</h2>
                <center>
                    <?php
                    if (isset($_GET["delok"])) {
                ...
                <div class="table-panel">
                    <table class="table-p">
                        ...
                        <?php
                        $query = "SELECT * FROM `economic` ORDER BY `id` DESC";
                        ...
                        while ($row = mysqli_fetch_array($result)) {
                            ...
                            <tr class="table-row">
                                ...
                                <td class="table-col tl">
                                    <a href="<?php echo "../code.php?economicid=$row[id]" ?>"> <i
                                            class=" bi bi-trash3 b red"></i></a>
                                    <a href="<?php echo "edit-economic.php?postid=$row[id]" ?>"><i
