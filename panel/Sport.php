      ...
      <div class="panel-box post-box">
        ...
        <div class="form-panel">
          <form action="../code.php" method="Post" enctype="multipart/form-data">
            ...
            <textarea class="input-form textarea-form" placeholder="متن خبر " name="content" required></textarea>
            <input class="input-form submit-form" type="submit" name="btnsportsend" value="انتشار پست" />
            <br />
          </form>
        </div>
      </div>
